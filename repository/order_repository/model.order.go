...
import (
	...
	"github.com/edwinjordan/e-canteen-backend/repository/customer_address_repository"
...
type CustomerOrder struct {
	...
	OrderDetail            *[]ViewOrderDetail                           `gorm:"foreignKey:OrderDetailParentId;references:OrderId"`
...
func (model *CustomerOrder) ToEntity() *entity.CustomerOrder {
	...
	if model.OrderDetail != nil {
		var tempMenu []entity.ViewOrderDetail
